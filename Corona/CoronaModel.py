...
class CoronaDelayModel(stm.Model):
    def __init__(self, AllMeasured, Tmax = 150, lossWeight={}):
        ...
        infect_first_init = (1.0 * RelPopulation/ self.PopSum/detect_Init).astype(np.float32) # Amount of first infection  (1.0 would be 5e-7 )
        ...
        R = self.newVariables({'R': Ones_Age * AllRInit}, forcePos=True)  #
        R_rate = lambda t: R()[t]
