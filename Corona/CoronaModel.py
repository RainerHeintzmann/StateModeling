...
class CoronaDelayModel(stm.Model):
    def __init__(self, AllMeasured, Tmax = 150, lossWeight={}):
        ...
        for d in  range(AllMeasured['Cases'].shape[1]):
        ...
        self.newState(name='I', axesInit={"District": 0.0, "Disease Progression": 0})
        self.newState(name='D', axesInit={"District": 0.0})
        self.newState(name='C', axesInit={"District": 0.0})
        ...
        R_rate = lambda t: R()[t]
        RelPopulation = np.squeeze(AllMeasured['Population'] / self.PopSum)
    ...
    def showSimRes(self, ymin=0.0001,ymax=1.0):
        ...
        p=self.showResultsBokeh(title=self.AllMeasured['Region'], ylabel='occupancy',
                      xlim=xlim, dims = ("District"), initMinus=['S'], allowCumul=False,
        ...
        p=self.showResultsBokeh(title=self.AllMeasured['Region'], ylabel='Rate',
                      xlim=xlim, subPlot='R', dims = ("District"), allowCumul=False,
