...
def CoronaModel(AllMeasured):
    ...
    T0 = M.newVariables({"T0": T0Init * np.ones(M.Axes['District'].shape, stm.CalcFloatStr)}, forcePos=False, displayLog=False)  # time at which a delta is injected into the start of the progression axis
    ...
    aT0 = M.newVariables({'aT0': aT0Init}, forcePos=True, displayLog=False)  # awarenessTime
    ...
    it0 = M.newVariables({'it0': it0Init}, forcePos=True, displayLog=False) # day of most probably infecting someone else
